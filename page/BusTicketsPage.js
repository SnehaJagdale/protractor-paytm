...
var productList = element.all(by.xpath(".//*[@id='site-wrapper']/div[5]/div/span/div[1]/div[4]/div[9]"));//.product-listing .grid-tic.ng-scope'));
...
var seat = element(by.xpath(".//*[@id='site-wrapper']/div[5]/div/span/div[1]/div[4]/div[3]/div[8]/div[2]/div/div[1]/div/ul[2]/li[1]/a/img[5]"));
var dropdownItems = element(by.xpath(".//*[@class='grid-tic ng-scope'][2]//*[@id='boarding-point']/ul/li[1]"));//.//*[@id='boarding-point']/ul/li[1]"));
var dropdown = element(by.xpath("//div[@class='seats-chart clear active']/div[2]/div/div[2]/div[6]/div[1]/ul")); //css('ul.drpdwn-arrow-bus1'));//
var proccedButton = element(by.xpath(".//*[@id='site-wrapper']/div[5]/div/span/div[1]/div[4]/div[9]/div[10]/div[2]/div/div[2]/div[9]/button")); //css('button.btn.btn-primary.btn-block.w-240'));
var busType = element(by.xpath("//*[@id='site-wrapper']/div[5]/div/span/div[1]/div[3]/div[3]/div/ol/li[1]/div/span"));
var busOperators = element(by.xpath(".//*[@id='site-wrapper']/div[5]/div/span/div[1]/div[3]/div[5]/div/ol/li[2]/div"));
